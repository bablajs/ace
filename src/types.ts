...
export type FindingHookHandler = HookHandler<
  FindingHookArgs[0],
  FindingHookArgs[1]
>;
...
export type LoadingHookHandler = HookHandler<
  LoadingHookArgs[0],
  LoadingHookArgs[1]
>;
 ...
 * Found hook handler and data
 */
export type LoadedHookArgs<Command extends AbstractBaseCommand> = [
  [Command],
  [Command],
];
export type LoadedHookHandler<Command extends AbstractBaseCommand> =
  HookHandler<
 ...
 */
export type ExecutingHookArgs<Command> = [
  [Command, boolean],
  [Command, boolean],
];
